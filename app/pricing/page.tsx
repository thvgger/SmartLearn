  ...
  return (
    <div className="bg-background text-foreground font-body selection:bg-primary/30 min-h-screen flex flex-col">
      ...
      <main className="pt-32 pb-24 px-6 max-w-7xl mx-auto relative overflow-hidden flex-grow">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-gradient-to-b from-blue-600/10 to-transparent blur-[120px] -z-10"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-start">
          ...
          <Card className="bg-zinc-900 border-white/10 rounded-3xl flex flex-col h-full hover:border-white/20 transition-all p-0 overflow-hidden">
            <div className="bg-zinc-800/80 p-8 pb-10 border-b border-white/5 relative">
              ...
              <div>
                <span className="font-headline text-5xl font-extrabold text-white tracking-tighter">{isYearly ? "₦1,125" : "₦1,500"}</span>
                <span className="text-zinc-400 text-sm font-medium"> / Month</span>
              </div>
              {isYearly && <p className="absolute bottom-3 left-8 text-[10px] text-zinc-500 font-bold uppercase tracking-widest">₦13,500 billed annually</p>}
            </div>
            <div className="p-8 flex-grow flex flex-col bg-zinc-900">
              <ul className="space-y-5 mb-8 flex-grow">
                {[
          ...
          <div className="relative flex flex-col h-full lg:scale-105 z-10">
            <Card className="bg-zinc-900 border-blue-500/30 rounded-3xl flex flex-col h-full shadow-[0_0_40px_-10px_rgba(99,102,241,0.2)] p-0 overflow-hidden">
              <div className="bg-blue-600 p-8 pb-10 relative">
                ...
                <div>
                  <span className="font-headline text-5xl font-extrabold text-white tracking-tighter">{isYearly ? "₦2,250" : "₦3,000"}</span>
                  <span className="text-blue-200 text-sm font-medium"> / Month</span>
                </div>
                {isYearly && <p className="absolute bottom-3 left-8 text-[10px] text-blue-200 font-bold uppercase tracking-widest">₦27,000 billed annually</p>}
              </div>
              <div className="p-8 flex-grow flex flex-col bg-zinc-900">
                <ul className="space-y-5 mb-8 flex-grow">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-sm text-zinc-300 font-medium">
                      <div className="rounded-full p-0.5 border border-blue-500/50 bg-blue-500/10 shrink-0">
                        <Icon icon="ri:check-line" className="text-blue-400 w-3 h-3" />
                      </div>
                      {feature}
                    </li>
                  ))}
                ...
                <Button 
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold h-12 rounded-full shadow-lg shadow-blue-600/20 transition-all"
                >
          ...
          <Card className="bg-zinc-900 border-white/10 rounded-3xl flex flex-col h-full hover:border-white/20 transition-all p-0 overflow-hidden">
            <div className="bg-zinc-800/80 p-8 pb-10 border-b border-white/5 relative">
              ...
              <div>
                <span className="font-headline text-5xl font-extrabold text-white tracking-tighter">{isYearly ? "₦3,750" : "₦5,000"}</span>
                <span className="text-zinc-400 text-sm font-medium"> / Month</span>
              </div>
              {isYearly && <p className="absolute bottom-3 left-8 text-[10px] text-zinc-500 font-bold uppercase tracking-widest">₦45,000 billed annually</p>}
            </div>
            <div className="p-8 flex-grow flex flex-col bg-zinc-900">
              <ul className="space-y-5 mb-8 flex-grow">
                {[
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <Card className="md:col-span-8 bg-zinc-900 border-white/10 p-10 rounded-2xl flex flex-col justify-between overflow-hidden relative group hover:border-white/20 transition-all">
              <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/5 blur-3xl -z-10 group-hover:bg-blue-500/10 transition-all"></div>
              ...
              <div className="mt-12 flex gap-4 overflow-hidden -mr-10">
                ...
                <div className="w-48 h-32 bg-zinc-900/50 rounded-xl border border-white/5 shrink-0 p-4">
                  <div className="w-1/3 h-1 bg-blue-400 mb-2"></div>
            ...
            <Card className="md:col-span-4 bg-zinc-900 border-white/10 p-10 rounded-2xl flex flex-col justify-center items-center text-center group hover:border-white/20 transition-all">
              <Icon icon="ri:shield-line-check" className="text-blue-400 w-12 h-12 mb-6 group-hover:scale-110 transition-transform" />
            ...
            <Card className="md:col-span-4 bg-zinc-900 border-white/10 p-10 rounded-2xl group hover:border-white/20 transition-all">
              <Icon icon="ri:dashboard-line" className="text-blue-400 w-12 h-12 mb-6 group-hover:scale-110 transition-transform" />
            ...
            <Card className="md:col-span-8 bg-zinc-900 border-white/10 p-10 rounded-2xl relative overflow-hidden group hover:border-white/20 transition-all">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent -z-10"></div>
              <div className="flex flex-col md:flex-row gap-8 items-center h-full">
                ...
                <div className="w-full md:w-1/3 aspect-video bg-zinc-900 rounded-xl border border-white/5 flex items-center justify-center group-hover:bg-zinc-800 transition-colors shadow-2xl">
                  <Icon icon="ri:cloud-line-off" className="text-blue-500/30 w-16 h-16" />
                </div>
              </div>
            </Card>
          </div>
