          ...
          <>
            ...
            <div className="flex items-center gap-4">
              {loading ? (
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger render={<button className="flex items-center gap-2 p-1.5 pl-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 transition-all group outline-none" />}>
                ...
                <>
                  ...
                  <Button render={<Link href="/register" />} className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-6 shadow-lg shadow-indigo-600/20">
                    Get Started
                  </Button>
                </>
              )}
